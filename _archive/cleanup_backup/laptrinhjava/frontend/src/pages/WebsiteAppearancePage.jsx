    ...
    <section className="page-section asset-manager-page">
      ...
      <article className="glass-card mb-4" style={{ marginBottom: '24px' }}>
        <div className="asset-manager-header" style={{ borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '16px', marginBottom: '16px' }}>
          ...
          <p style={{ color: '#8ea5c1', fontSize: '0.9rem' }}>Nội dung này là cấu hình giao diện admin, còn nội dung công khai sẽ ưu tiên lấy từ published content.</p>
        </div>
        ...
        <p style={{ marginTop: '12px', color: '#8ea5c1' }}>Public preview từ content backend: {liveAnnouncement}</p>
      </article>
