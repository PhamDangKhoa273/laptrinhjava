...
import {
  ...
  createAdminAccount, deleteUserAccount
...
export function AdminDashboardPage({ defaultTab = 'users' }) {
  ...
  async function handleDeleteUser(id) {
    ...
    try {
      ...
      setStatusMessage('Đã xoá tài khoản thành công.')
      await loadAdminData()
    } catch {
      setStatusMessage('Không xoá được tài khoản.')
  ...
  async function handleReviewFarm(farmId, approvalStatus) {
    try {
      ...
      setStatusMessage('')
      // reviewFarm is provided by the admin service layer in this project
      ...
      setStatusMessage('Không duyệt được nông trại.')
    } finally {
      setBusyFarmId(null)
    }
  }
