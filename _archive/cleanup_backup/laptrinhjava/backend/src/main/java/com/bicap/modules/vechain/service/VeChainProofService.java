...
public class VeChainProofService {
    ...
    public String commitSeasonExportProof(String canonicalHashHexNo0x, String traceCode) {
        ...
        System.out.println("[VECHAIN] txSeed=" + txSeed + ", blockRef=" + blockRef + ", chainTag=" + chainTag + ", nonce=" + nonce + ", gas=" + gas + ", to=" + to);
        ...
        System.out.println("[VECHAIN] intrinsicGas=" + tx.getIntrinsicGas());
        ...
        System.out.println("[VECHAIN] origin=" + origin + ", signingHashLen=" + signingHash.length + ", sigLen=" + sig.length + ", v=" + (sig[64] & 0xff));
        tx.setSignature(sig);

        String raw = "0x" + Utils.bytesToHex(tx.encode());
        System.out.println("[VECHAIN] rawTxLen=" + raw.length() + ", txId=" + tx.getIdAsString());
        try {
