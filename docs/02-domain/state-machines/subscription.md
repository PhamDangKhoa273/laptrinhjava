...
|---|---|---|---|---|---|---|
| STM-SUB-T01 | (none) | PENDING_PAYMENT | farm_manager | POST /api/v1/farm-subscriptions | BR-SUB-010; if a still-effective subscription exists, create queued `startDate = latestEffectiveEndDate + 1 day` | BR-SUB-010, BR-SUB-075 |
| STM-SUB-T02 | PENDING_PAYMENT | ACTIVE | system | event: PaymentCallbackVerified | BR-SUB-020 | BR-SUB-020, BR-SUB-075 |
