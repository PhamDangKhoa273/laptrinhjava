...
- 2026-05-19: Batch QR responses use the current frontend Origin for localhost-backed QR URLs, so LAN/mobile scans can resolve public trace links when the web app is opened through the machine LAN address.
