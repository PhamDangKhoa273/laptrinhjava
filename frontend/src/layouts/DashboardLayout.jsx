...
const roleLinks = {
  ...
  [ROLES.SHIPPING_MANAGER]: [
    { section: true, label: 'TỔNG QUAN' },
    { to: '/dashboard/shipping-manager', label: 'Bảng điều khiển', icon: 'overview', description: 'KPI vận chuyển' },
    { section: true, label: 'ĐƠN HÀNG VÀ VẬN CHUYỂN' },
    { to: '/shipping/orders', label: 'Quản lý đơn hàng', icon: 'orders', description: 'Xem, tạo, theo dõi và hủy chuyến hàng' },
    { to: '/shipping/completed', label: 'Đơn hàng hoàn thành', icon: 'completed', description: 'Đơn thành công giữa nhà bán lẻ và trang trại' },
    { section: true, label: 'QUẢN LÝ' },
    { to: '/shipping/drivers', label: 'Tài xế', icon: 'drivers', description: 'Quản lý tài xế' },
    { to: '/shipping/vehicles', label: 'Phương tiện', icon: 'vehicles', description: 'Quản lý phương tiện' },
    { section: true, label: 'LIÊN LẠC VÀ BÁO CÁO' },
    { to: '/shipping/sendnotification', label: 'Gửi thông báo', icon: 'messages', description: 'Gửi đến nông trại, nhà bán lẻ hoặc admin' },
    { to: '/shipping/reports', label: 'Báo cáo từ tài xế', icon: 'shipmentReports', description: 'Sự cố vận hành' },
    { section: true, label: 'TÀI KHOẢN' },
    { to: '/shipping/profile', label: 'Hồ sơ cá nhân', icon: 'profile', description: 'Thông tin tài khoản' },
  ],
  [ROLES.DRIVER]: [
